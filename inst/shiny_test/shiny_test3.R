...
# Vecteur label → valeur (pour les choices de radioButtons) :
#   les NOMS du vecteur sont affichés, les VALEURS sont retournées par input
metrique_choices <- c(
  "Prix / Ventes"  = "p_to_s",
...
# Vecteur valeur → label (pour afficher le label dans le titre du graphique)
